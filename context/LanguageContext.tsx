...
const translations = {
  es: {
    ...
    hero: {
      ...
      black_friday: "OWNSTAR",
      sale_text: "NUEVA COLECCIÓN",
      rotating_texts: ["NUEVA COLECCIÓN", "ENVÍO GRATIS +100€", "CALIDAD PREMIUM", "DISEÑO EXCLUSIVO"],
      shop_now: "VER COLECCIÓN",
    },
    footer: {
      explore: "Explorar",
      help: "Ayuda",
  ...
  en: {
    ...
    hero: {
      ...
      rotating_texts: ["NEW COLLECTION", "FREE SHIPPING +100€", "PREMIUM QUALITY", "EXCLUSIVE DESIGN"],

...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-white text-black pt-24 pb-10 px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-32">
          ...
          <div className="lg:col-span-4 flex flex-col justify-between order-2 lg:order-1 pt-4">
            <div className="space-y-8">
              ...
              <p className="text-lg md:text-xl font-medium leading-relaxed text-black">
                Lo que empezó como conversaciones interminables entre dos amigos en una habitación, se convirtió en <span className="font-bold">OWNSTAR</span>.
              </p>
              
              <p className="text-sm md:text-base text-neutral-800 leading-relaxed text-justify">
                No queríamos ser simplemente otra marca de ropa. Veíamos cómo la moda rápida consumía la identidad de la calle, y decidimos ir en la dirección opuesta. Nos enfocamos en la <strong>exclusividad</strong>.
              </p>

              <p className="text-sm md:text-base text-neutral-800 leading-relaxed text-justify">
                Nuestra filosofía es simple: <span className="italic">Less is more, but make it heavy.</span> Trabajamos con el concepto de "Drops" (colecciones limitadas) porque creemos que lo que llevas puesto debe sentirse especial. Cada pieza tiene una historia, un porqué y, sobre todo, una identidad que compartimos.
              </p>
            </div>
          ...
          <div className="lg:col-span-8 order-1 lg:order-2">
            <div className="relative h-[70vh] min-h-[500px] w-full overflow-hidden bg-neutral-100 rounded-sm">
              {/* 
                NOTE: User needs to save their image as 'founders.jpg' in the public folder.
                Using a placeholder logic or specific path.
              */}
              <Image
                src="/founders.jpg"
              ...
              <div className="absolute bottom-0 right-0 bg-black text-white p-6 backdrop-blur-sm bg-opacity-90">
                 ...
                 <p className="text-[10px] uppercase tracking-widest opacity-70">Passion</p>
                 <p className="text-4xl font-bold tracking-tighter mt-2">50%</p>
                 <p className="text-[10px] uppercase tracking-widest opacity-70">Hustle</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center border-t border-black pt-20 mb-20">
           ...
           <div className="space-y-6">
             <p className="text-xl md:text-2xl font-light">
               "Creamos para quienes entienden que el estilo es el primer paso de la comunicación no verbal."
             </p>
             <Link href="/shop" className="inline-flex items-center gap-2 text-sm font-bold uppercase tracking-wide hover:underline decoration-2 underline-offset-4">
